<main class="pagina">
    ...
    <p class="pagina__descripcion">Elije 5 eventos para asistir de Forma Presencial</p>
    ...
    <div class="evento-registro">
        <main class="evento-registro__listado">
            ...
            <p class="evento-registro__fecha">Viernes 5 de Octubre</p>
            ...
            <p class="evento-registro__fecha">Sabado 6 de Octubre</p>
            <div class="evento-registro__grid">
