    ...
    <?php if (isset($ponente->imagen_actual)) { ?>
        ...
        <div class="formulario__imagen">
            <picture>
                ...
                <img loading="lazy" width="200" height="300" src="<?php echo $_ENV['HOST'] . '/img/speakers/' . $ponente->imagen; ?>.png" alt="Imagen Ponente">
            </picture>
        </div>
    <?php } ?>
...
<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        <div class="formulario__contenedor-icono">
            ...
            <input type="text" class="formulario__input--sociales" name="redes[tiktok]" placeholder="Tik Tok" value="<?php echo $redes->tiktok ?? '' ?>">
        </div>
    </div>
