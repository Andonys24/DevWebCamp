...
class Paginacion
{
    ...
    {
        return ($this->pagina_actual > 0) ? ($this->pagina_actual - 1) * $this->registros_por_pagina : 0;
    }
    ...
    public function enlace_anterior()
    {
        ...
        if ($this->pagina_anterior()) {
            $html .= "<a class=\"paginacion__enlace paginacion__enlace--texto\" href='?page={$this->pagina_anterior()}' class='siguiente'>&laquo; Anterior</a>";
        }
        return $html;
    }
    ...
    public function enlace_siguiente()
    {
        ...
        if ($this->pagina_siguiente()) {
            $html .= "<a class=\"paginacion__enlace paginacion__enlace--texto\" href='?page={$this->pagina_siguiente()}' class='siguiente'>Siguiente &raquo;</a>";
        }
        return $html;
    }
